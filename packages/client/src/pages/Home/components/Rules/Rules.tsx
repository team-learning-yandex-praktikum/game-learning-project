        ...
        <div className={style.content}>
            ...
            <div className={style.about}>
                ...
                <div>
                    <div className={style.textCenter}>
                        В Jump-Jump нужно прыгать по
                    </div>
                    <div>
                        платформам, чтобы добраться до конца уровня. В игре
                        присутствует элемент случайности, который может повлиять
                        на исход уровня.
                    </div>
                </div>
            </div>
            ...
            <div className={style.rules}>
                ...
                <div className={style.rulesText}>
                    <div>
                        Если игрок упадет с платформы, он потеряет жизнь. После
                        этого он должен начать уровень заново.
                    </div>
                    <div>
                    ...
                    <div>
                        Игрок должен только корректировать мышью направление его
                        полета (нажимать на клавишу мыши не нужно, просто
